INSERT INTO AUTHOR (id, first_name, last_name) VALUES (nextval('author_seq'),'Suzanne', 'Collins');
INSERT INTO BOOK (author_id, id, title, genre, description, rate) VALUES (
identity(),
nextval('book_seq'),
'The Hunger Games',
'Adventure',
...
INSERT INTO AUTHOR (id, first_name, last_name) VALUES (nextval('author_seq'), 'Joanne', 'Rowling');
INSERT INTO BOOK (author_id, id, title, genre, description, rate) VALUES (
identity(),
nextval('book_seq'),
...
INSERT INTO AUTHOR (id, first_name, last_name) VALUES (nextval('author_seq'), ' Harper', 'Lee');
INSERT INTO BOOK (author_id, id, title, genre, description, rate) VALUES (
identity(),
nextval('book_seq'),
'Go Set a Watchman',
...
INSERT INTO AUTHOR (id, first_name, last_name) VALUES (nextval('author_seq'), 'Jane', 'Austen');
INSERT INTO BOOK (author_id, id, title, genre, description, rate) VALUES (
identity(),
nextval('book_seq'),
'Pride and Prejudice',
...
INSERT INTO AUTHOR (id, first_name, last_name) VALUES (nextval('author_seq'), 'Stephenie', 'Meyer');
INSERT INTO BOOK (author_id, id, title, genre, description, rate) VALUES (
identity(),
nextval('book_seq'),
'Twilight',
...
INSERT INTO AUTHOR (id, first_name, last_name) VALUES (nextval('author_seq'), ' George', 'Orwell');
INSERT INTO BOOK (author_id, id, title, genre, description, rate) VALUES (
identity(),
nextval('book_seq'),
'Animal Farm',
...
INSERT INTO AUTHOR (id, first_name, last_name) VALUES (nextval('author_seq'), 'Markus', 'Zusak');
INSERT INTO BOOK (author_id, id, title, genre, description, rate) VALUES (
identity(),
nextval('book_seq'),
'The Book Thief',
...
INSERT INTO AUTHOR (id, first_name, last_name) VALUES (nextval('author_seq'), 'Clive', 'Lewis');
INSERT INTO BOOK (author_id, id, title, genre, description, rate) VALUES (
identity(),
nextval('book_seq'),
...
INSERT INTO AUTHOR (id, first_name, last_name) VALUES (nextval('author_seq'), 'John Ronald Reuel', 'Tolkien');
INSERT INTO BOOK (author_id, id, title, genre, description, rate) VALUES (
identity(),
nextval('book_seq'),
...
INSERT INTO AUTHOR (id, first_name, last_name) VALUES (nextval('author_seq'), 'Margaret', 'Mitchell');
INSERT INTO BOOK (author_id, id, title, genre, description, rate) VALUES (
identity(),
nextval('book_seq'),
'Gone with the Wind',
...
INSERT INTO AUTHOR (id, first_name, last_name) VALUES (nextval('author_seq'), 'John', 'Green');
INSERT INTO BOOK (author_id, id, title, genre, description, rate) VALUES (
identity(),
nextval('book_seq'),
...
INSERT INTO AUTHOR (id, first_name, last_name) VALUES (nextval('author_seq'), 'Shel', 'Silverstein');
INSERT INTO BOOK (author_id, id, title, genre, description, rate) VALUES (
identity(),
nextval('book_seq'),
'The Giving Tree',
...
INSERT INTO AUTHOR (id, first_name, last_name) VALUES (nextval('author_seq'), 'Emily', 'Brontë');
INSERT INTO BOOK (author_id, id, title, genre, description, rate) VALUES (
identity(),
nextval('book_seq'),
'Wuthering Heights',
...
INSERT INTO AUTHOR (id, first_name, last_name) VALUES (nextval('author_seq'), 'Dan', 'Brown');
INSERT INTO BOOK (author_id, id, title, genre, description, rate) VALUES (
identity(),
nextval('book_seq'),
'The Da Vinci Code',
...
INSERT INTO AUTHOR (id, first_name, last_name) VALUES (nextval('author_seq'), 'Arthur', 'Golden');
INSERT INTO BOOK (author_id, id, title, genre, description, rate) VALUES (
identity(),
nextval('book_seq'),
'Memoirs of a Geisha',
...
INSERT INTO AUTHOR (id, first_name, last_name) VALUES (nextval('author_seq'), 'Lewis', 'Carroll');
INSERT INTO BOOK (author_id, id, title, genre, description, rate) VALUES (
identity(),
nextval('book_seq'),
...
INSERT INTO AUTHOR (id, first_name, last_name) VALUES (nextval('author_seq'), 'Oscar', 'Wilde');
INSERT INTO BOOK (author_id, id, title, genre, description, rate) VALUES (
identity(),
nextval('book_seq'),
...
INSERT INTO AUTHOR (id, first_name, last_name) VALUES (nextval('author_seq'), 'Charlotte', 'Brontë');
INSERT INTO BOOK (author_id, id, title, genre, description, rate) VALUES (
identity(),
nextval('book_seq'),
'Jane Eyre',
...
INSERT INTO AUTHOR (id, first_name, last_name) VALUES (nextval('author_seq'), 'Veronica', 'Roth');
INSERT INTO BOOK (author_id, id, title, genre, description, rate) VALUES (
identity(),
nextval('book_seq'),
'Divergent',
...
INSERT INTO AUTHOR (id, first_name, last_name) VALUES (nextval('author_seq'), 'William', 'Shakespeare');
INSERT INTO BOOK (author_id, id, title, genre, description, rate) VALUES (
identity(),
nextval('book_seq'),
'Romeo and Juliet',
